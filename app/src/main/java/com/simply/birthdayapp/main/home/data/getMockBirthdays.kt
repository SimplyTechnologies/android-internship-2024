    ...
    return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        listOf(
            Birthday(
                ...
                date = LocalDateTime.of(1990, 5, 10, 0, 0),
                id = 1,
                ...
                relation = "Friend",
                upcomingAge = 34,
                upcomingBirthday = LocalDateTime.of(2024, 5, 10, 0, 0),
                updatedAt = LocalDateTime.now(),
                userId = 1
            ),
            Birthday(
                createdAt = LocalDateTime.now().minusDays(20),
                date = LocalDateTime.of(1985, 7, 22, 0, 0),
                id = 2,
                ...
                relation = "Colleague",
                upcomingAge = 39,
                upcomingBirthday = LocalDateTime.of(2024, 7, 22, 0, 0),
                updatedAt = LocalDateTime.now(),
                userId = 2
            ),
            Birthday(
                createdAt = LocalDateTime.now().minusDays(30),
                date = LocalDateTime.of(2000, 12, 1, 0, 0),
                id = 3,
                ...
                relation = "Sister",
                upcomingAge = 24,
                upcomingBirthday = LocalDateTime.of(2024, 12, 1, 0, 0),
                updatedAt = LocalDateTime.now(),
                userId = 3
            ),
            Birthday(
